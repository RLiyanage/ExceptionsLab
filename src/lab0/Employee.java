...
public class Employee {
    ...
    public final void setDaysVacation(int daysVacation)throws IllegalArgumentException{
        if(daysVacation<0 ||daysVacation>28){
            throw new IllegalArgumentException("Days vacation cannnot be less than 0 greater than 28");
        }
    ...
    public final void setSsn(String ssn)throws IllegalArgumentException {
        if(ssn == null||ssn.length()<11){
         throw new IllegalArgumentException ("social security number have 11 Strings including 9 numbers.");  
        }
        this.ssn = ssn;
    }
